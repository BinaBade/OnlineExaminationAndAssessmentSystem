...
namespace LogicLayer.SQLHelper
{
    public partial class SQLHandler
    {
        ...
        private string _connectionString = "Data Source=DESKTOP-AFR309N;Initial Catalog=OnlineExamination;Integrated Security=True;Persist Security Info=False;Connect Timeout=120";//Configuration.GetConnectionString("BloggingDatabase")
        ...
        public List<T> ExecuteAsTableList<T>(string StroredProcedureName, List<KeyValuePair<string, object>> ParaMeterCollection, bool isStructured)
        {
            SqlConnection SQLConn = new SqlConnection(this._connectionString);
            try
            {
